...
public:
    ...
    bool dominate_larger(const HyperRect& rect) const;
    bool dominate(const Instance& other) const;
    bool cross(const HyperRect& rect) const;
    bool cross_larger(const HyperRect& rect) const;
    ...
    bool fdominate_V_larger(const Instance& other, const vector<Point>& vertex) const;
